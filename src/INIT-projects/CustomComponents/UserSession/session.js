...
export const initializeUserSession = async (telegramUser) => {
    try {
        ...
        console.log("User session initialized:", response.data);
        return response.data;
    } catch (error) {
        console.error("Error initializing user session:", error.message);
        throw error;
    }
};
