            ...
            <List>
                ...
                <Section>
                    <Cell multiline subhead="Тезисы занятия:">
                        <ul>
                            <li>В 90% случаев патологий (метаболический синдром, инсулинорезистентность, гипертония,
                                дислипидемия, диабет и другие) причиной является ожирение вследствие образа жизни.
                            </li>
                            <li>Остальные 10% относятся к дисфункции щитовидной железы (гипотиреоз, гиперкортицизм,
                                гиперпролактинемия), сопровождающиеся явными симптомами.
                            </li>
