            ...
            <List>
                ...
                <Section>
                    <Cell
                        multiline
                    >
                        Тренировкой мы не отработаем съеденные калории, не получится, если вы будете увеличивать физ
                        нагрузки, компенсация будет за счет увеличения аппетита
                    </Cell>
                    <Cell
                        multiline
                    >
                    ...
                    <Cell
                        multiline
                    >
                        Обратите внимание, чтоб отработать один сникерс нужно заниматься полтора часа в тренажерном
                        зале, но после такого продолжительного изнурительного занятия, аппетит поднимется и мы опять
                        больше съедим, чем потратили
                    </Cell>
                    <Cell
                        multiline
                        subhead="Тезисы:"
                    >
                        <ul>
                            ...
                            <li>Важно не скорость, а объем выполненой работы. Бежать или идти пешком, решать вам, но
                                калорий потратите одинаково
                            </li>
                            <li>Продолжительные пешие прогулки или кардио тренировки нужны, чтоб развить выносливость
                            </li>
                            <li>Чем вынослевее вы станете, тем больше сможете сделать объема, тем больше калорий
                                сожгете
                            </li>
                            <li>Сочетаем силовую нагрузки с аэробной (кардио)</li>
                            <li>Силовая тренировка нужна, чтоб нарастить/сохранить мышцы, которые будут видно ПОСЛЕ
                                похудения
                            </li>
                            <li>Повышаем бытовую активность - уборка дома, строительство, ремонт, количество шагов за
                                день, лестница заместо лифтов и эсколаторов
                            </li>
